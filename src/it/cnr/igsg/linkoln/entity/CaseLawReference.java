...
public class CaseLawReference extends Reference {
	...
	public boolean isCaseLawReference() {
		...
		if(getRelatedEntity("CL_AUTH") != null || getRelatedEntity("CL_DOCTYPE") != null) {
			
			hasCL = true;
		}
		
		if(name2sharedEntity.get("CL_AUTH") != null || name2sharedEntity.get("CL_DOCTYPE") != null) {
			
			hasCL = true;
		}
		
		if(isReference() && hasCL) {
