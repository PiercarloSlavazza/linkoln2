...
public class LegislationReference extends Reference {
	...
	public String getUrnNir() {
		...
		OfficialJournal gu = (OfficialJournal) getRelatedEntity("OFF_JOURNAL");
		
		//Precedenza alla url di Gazzetta Ufficiale
		if(gu != null) {
			
			String guUrl = gu.getUrl();
		...
		AnnotationEntity alias = this.getRelatedEntity("LEG_ALIAS");
		...
		AnnotationEntity docType = this.getRelatedEntity("LEG_DOCTYPE");
		
		if(docType == null) {
			
			docType = this.getRelatedEntity("DOCTYPE");
		}
		
		AnnotationEntity legAuth = this.getRelatedEntity("LEG_AUTH");

		AnnotationEntity number = this.getRelatedEntity("NUMBER");
		
		AnnotationEntity year = null;
		
		AnnotationEntity date = this.getRelatedEntity("DATE");
